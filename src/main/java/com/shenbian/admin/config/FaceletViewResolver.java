...
/**
 * @author Andrzej, by isaac.silva
 *         http://forum.springsource.org/showthread.php?27213-how-to-configure-spring-MVC-view-resolver-for-facelets&p=298821#post298821
 */
public class FaceletViewResolver extends AbstractUrlBasedView {
    ...
    protected void renderMergedOutputModel(Map model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        FaceletViewResolver.notifyBeforeListeners(PhaseId.RESTORE_VIEW, facesLifecycle, facesContext);
        ...
        FaceletViewResolver.notifyAfterListeners(PhaseId.RESTORE_VIEW, facesLifecycle, facesContext);

        facesContext.setViewRoot(viewRoot);
        facesContext.renderResponse();
        try {
            FaceletViewResolver.notifyBeforeListeners(PhaseId.RENDER_RESPONSE, facesLifecycle, facesContext);
            ...
            FaceletViewResolver.notifyAfterListeners(PhaseId.RENDER_RESPONSE, facesLifecycle, facesContext);
        } catch (IOException e) {
